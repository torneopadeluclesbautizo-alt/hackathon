...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if(document.getElementById("regionChart")) {
    new Chart(document.getElementById("regionChart"), {
      ...
      data: {
        ...
        datasets: [{ label: "Nivel de Estrés", data: [90, 85, 60, 30], backgroundColor: ["#E8394A", "#E89B02", "#00A8CC", "#00E5A0"] }]
      },
      options: chartOptions
    });
  }
  ...
  if(document.getElementById("perdidaChart")) {
    new Chart(document.getElementById("perdidaChart"), {
      ...
      data: {
        ...
        datasets: [{ label: "% Pérdidas", data: [32.0, 31.0, 28.0, 25.0, 24.1, 21.3], backgroundColor: "#00A8CC" }]
      },
      options: chartOptions
    });
  }
  ...
  if(document.getElementById("ccaaChart")) {
    new Chart(document.getElementById("ccaaChart"), {
      ...
      indexAxis: "y",
      data: {
        labels: ["Andalucía", "C. Valenciana", "Murcia", "Cataluña", "Madrid"],
  ...
  if(document.getElementById("precioChart")) {
    new Chart(document.getElementById("precioChart"), {
      type: "bar",
      data: {
        labels: ["España", "Grecia", "Alemania", "Francia", "Media UE", "Dinamarca"],
